...
import { initialStateForm, Wine } from 'pages/Wine/interfaces';
import api from 'services/api-aws-amplify';
import { apiRoutes, appRoutes, systemColors } from 'utils/defaultValues';
import { formatDateHour } from 'utils/formatDate';
import BooleanTag from 'components/BooleanTag';
import WineSaleHitory from 'pages/WineSaleHitory/ListByWine';
...
const Details: React.FC = (props: any) => {
  ...
  const action = () => {
    history.push(`/${appRoutes.wines}/edit/${props.match.params.id}`);
  };
  ...
  return (
    <PanelCrud
      ...
      title={`Detalhes do vinho código (${props.match.params.id})`}
    >
      ...
      {state.id && <WineSaleHitory wineId={state.id} />}
    </PanelCrud>
  );
};
